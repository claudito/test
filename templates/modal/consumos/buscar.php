...
<div class="col-md-6">
 <div class="form-group">
  ...
  <input type="date" name="fechainicio" value="<?php echo $_SESSION['fechainicio_consumo']; ?>" class="form-control" required>
 </div> 
</div>
<div class="col-md-6">
  <div class="form-group">
  <label>FECHA FIN</label>
  <input type="date" name="fechafin" value="<?php echo $_SESSION['fechafin_consumo']; ?>" class="form-control" required>
  </div>
</div>
</div>
