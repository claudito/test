...
function loadTabla(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
      url:'../templates/modal/asociar-procesos-maquina/listar.php',
      data: parametros,
...
$.ajax({
  type: "POST",
  url: "../procesos/asociar-procesos-maquina/agregar.php",
  data: parametros,
   beforeSend: function(objeto){
...
$( "#eliminarDatos" ).submit(function( event ) {
    var parametros = $(this).serialize();
       $.ajax({
          type: "POST",
          url: "../procesos/asociar-procesos-maquina/eliminar.php",
          data: parametros,
           beforeSend: function(objeto){
            $("#mensaje").html("Mensaje: Cargando...");
            },
